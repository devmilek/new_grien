...
const CuisinePage = async ({ params, searchParams }: CuisinePageProps) => {
  ...
  return (
    <div className="container">
      <RecipesListHero
        ...
        subheading={`${recipesCount} przepisów w tej kuchni`}
        imageUrl="/food.jpg"
      />
      <div className="flex gap-6 items-start">
        <div className="max-w-[350px] w-full">
          <FacetedSearch hideCuisines={true} />
        </div>
