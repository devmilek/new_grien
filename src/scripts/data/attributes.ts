export const data = {
  categories: [
    ...
    },
    {
      name: "Przetwory",
      description:
        "Domowe konfitury, kiszonki i inne zapasy na zimowe miesiące.",
    },
    {
      name: "Dodatki",
      description:
        "Sosy, dipy i inne smakołyki, które wzbogacą smak Twoich dań.",
    },
    {
      name: "Pieczywo",
    ...
    },
    {
      name: "Wędliny",
      description:
        "Tradycyjne domowe wędliny, pasztety i inne mięsne specjały.",
    },
  ],
  occasions: [
    {
  ...
  cuisines: [
    ...
    },
    {
      ...
      description:
        "Zdrowa i lekka kuchnia pełna oliwek, ryb i świeżych warzyw.",
    },
    {
      name: "Żydowska",
      description:
        "Tradycyjne dania, takie jak chałka, gefilte fish i maczanka.",
    },
  ],
  diets: [
    {
